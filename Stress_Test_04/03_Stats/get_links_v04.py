...
# Define paths
res_dir="/dicos_ui_home/tlankau/QMMM_Work/Stress_04/Separation/Test-442293"
...
# save the dictionary
with open('/dicos_ui_home/tlankau/QMMM_Work/Stress_04/Stats/link_dict.pkl', 'wb') as fp:
  pickle.dump(sorted_dict, fp)
  fp.close()
  print('dictionary saved successfully to file')
# save mol_dict as a csv file
with open('/dicos_ui_home/tlankau/QMMM_Work/Stress_04/Stats/mol_dict.csv', 'w') as fp:
