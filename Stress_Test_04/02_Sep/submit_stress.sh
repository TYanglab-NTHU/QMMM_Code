...
script="/dicos_ui_home/tlankau/QMMM_Work/Stress_04/Separation/Code/stress.py"
base=`echo ${script} | rev | cut -f2- -d. | rev`
workdir="/tmp/tlankau"
startdir="/dicos_ui_home/tlankau/QMMM_Work/Stress_04/Separation"
homedir="/dicos_ui_home/tlankau/QMMM_Work/Stress_04/Separation"
pid=$SLURM_JOB_ID
if [ -z ${pid} ]
  then
