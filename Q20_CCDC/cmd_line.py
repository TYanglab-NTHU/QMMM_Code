...
# set the number of H atoms which trigges adding mising H atoms
# -2: set the default value of 10
# -1: always look for missing H atoms
# any positive interger or zero will do
qms.set_Hswitch(10)
...
if gb.VerboseFlag > 0:
  ...
  print('Switch for adding H atoms        ', qms.get_Hswitch())
